...
***Disclaimer: All art assets used are for demonstration and educational purposes. All rights are reserved to their original owners. If you (as a person or a company) own the art and do not wish it to be associated with this project, please contact us at 	5r33ch4@yahoo.com and we will gladly take it down.***

# v4 (Updated by 5R33CH4) [Anime4K+]

What's new:
 - Decreased Response Time **(< 4ms)**
 - Adaptive Super Smapling to increase efficiancy 
 - Real-time image sharpening **(for more crisp frames)**
 - Smart Shader Cashe Management **(to reduce GPU load on rendering already rendered frames)**
 - Further Optimizations & Bug Fixes

## v3 (Original Version by bloc07)
...
**[Installation Instructions for GLSL/MPV](GLSL Instructions.md)**  

[More information about each shader](https://github.com/5R33CH4/Anime4K-/wiki).
